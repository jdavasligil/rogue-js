...
export class TileGrid {
   ...
   */
  static from(json) {
    return new TileGrid(json.width, Uint8Array(Object.values(json.data)));
  }
...
export class IDGrid {
   ...
   * Create a tile array.
   * @param {number} width - The grid width N.
   * @param {Uint16Array | undefined} data - Array buffer or undefined.
   */
  constructor(width, data=undefined) {
    this.width = width;
    if (data === undefined) {
   ...
   */
  static from(json) {
    return new IDGrid(json.width, Uint16Array(Object.values(json.data)));
  }
...
export class BitGrid {
   ...
   */
  static from(json) {
    return new BitGrid(json.width, Uint8Array(Object.values(json.data)));
  }
