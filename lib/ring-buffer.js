...
export class RingBuffer {
  ...
  asArray() {
    ...
    if (this.front < this.back) {
      return Array.from(this.data.slice(this.front + 1, this.back + 1));
    }
    return Array.from(this.data.slice((this.front + 1) % this.capacity))
      .concat(Array.from(this.data.slice(0, this.back + 1)));
  }
}
