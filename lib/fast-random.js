...
export class FRNG {
  ...
  /**
   * Rolls a selection on a given percentile pdf array.
   * @param {function(): number} rng - Random number generator in range(0,1).
   * @param {Array.<number>} pdf - Array of percentile probabilities.
   * @returns {number} selection
   */
  static randPdf(rng, pdf) {
